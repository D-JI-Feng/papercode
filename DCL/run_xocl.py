...
from xocl import XOCL

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset', type=str, default='yelp', help='The datasets can be: \
    ...
    args.config_file_list = [
        ...
        'properties/XOCL.yaml',
        'properties/LOCL.yaml'
    ]
    ...
    model = XOCL(config, train_data.dataset).to(config['device'])
    logger.info(model)
